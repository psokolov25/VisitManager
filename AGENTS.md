...
- 2025-09-17: выполнена команда `mvn -s .mvn/settings.xml test`; успешно пройдено 420 автотестов. Совокупное покрытие JaCoCo: 54.03 % инструкций, 57.84 % строк, 38.90 % ветвей, 44.14 % сложности и 76.99 % методов (подробности — `target/site/jacoco/jacoco.csv`).
