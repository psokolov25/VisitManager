...
/**
 * REST API для создания визитов: виртуальные визиты,
 * визиты через входные точки и рецепцию.
 */
...
public class EntrypointController {
  ...
  /**
   * Создаёт виртуальный визит.
   *
   * @param branchId идентификатор филиала
   * @param servicePointId идентификатор рабочего места
   * @param serviceIds список идентификаторов услуг
   * @param sid идентификатор сессии (cookie)
   * @return созданный визит
   * @throws SystemException при системной ошибке
   */
