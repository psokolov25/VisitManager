...
//            entryPoint.setPrinterId("2");
//            entryPoint.setId("2");
//            AtomicReference<HashMap<String, EntryPoint>> entryPoints2 = new AtomicReference<>(new HashMap<>());
//            entryPoints2.get().put(entryPoint2.getId(), entryPoint);
//            branch.setEntryPoints(entryPoints);
//            Queue queueCredit2 = new Queue("9828de92-17c0-4616-bc5b-3971a778fe2a", "Кредиты", "F");
//            Service creditService2 = new Service("1ebff05b-5aa4-462d-9e9c-fb889852535c", "Кредит", 9000, queueCredit.getId());
//            Outcome creditAccepted2 = new Outcome("dccf0b9e-cb77-4af2-a50e-56189f6e3cc8", "Одобрен");
//            creditAccepted2.setCode(1L);
//            creditService2.getPossibleOutcomes().put(creditAccepted.getId(),creditAccepted);
//            DeliveredService creditCard2=new DeliveredService("d71d3564-05b6-4f42-b17d-c2ea8aaa4c8c","Кредитная карта");
//            creditCard2.getServviceIds().add(creditService2.getId());
//            Outcome creditCardGiven2 = new Outcome("8dc29622-cd87-4384-85a7-04b66b28dd0f", "Выдана");
...
//
//
//            DeliveredService insurance2=new DeliveredService("414e779a-b7c2-49a1-9917-951f3cb6cd26","Страховка");
//            insurance2.getServviceIds().add(creditService2.getId());
//            branch2.getPossibleDeliveredServices().put(insurance.getId(),insurance);
//
//            Queue queueBigCredit2 = new Queue("325fc045-a69e-4154-bfe7-204747823583", "Очень большие кредиты", "S");
//            Service bigCreditService2 = new Service("64e4d564-817c-4629-bc02-2df72affa38a", "Очень большой кредит", 9000, queueBigCredit2.getId());
//
//            Queue queueC2 = new Queue("c0c52932-87bd-4388-8620-97e08568b851", "В кассу", "C");
//            Service kassaService2 = new Service("9cacbc14-9735-4e73-b882-dfac2bb7d7c9", "Касса", 9000, queueC2.getId());
//            ServicePoint servicePointFC2 = new ServicePoint("993211e7-31c8-4dcf-bab1-ecf7b9094d4c", "Финансовый консультант");
...
//
//            ServicePoint servicePointFSC2 = new ServicePoint("eabd0664-f3bf-4492-b8f0-be2b80e3d09d", "Старший финансовый консультант");
//            ServicePoint servicePointC2 = new ServicePoint("403e1987-3c3a-4bb9-be5e-fcf951f86023", "Касса");
//            WorkProfile workProfileC2 = new WorkProfile("Кассир");
//            workProfileC2.getQueueIds().add(queueC.getId());
//            WorkProfile workProfileFC2 = new WorkProfile("cf1ebcd9-b757-4a48-810e-5c2be413c993","Финансовый консультант");
//            workProfileFC2.getQueueIds().add(queueCredit2.getId());
//            WorkProfile workProfileFSC2 = new WorkProfile("1df69e27-7bdf-4084-88a4-52344a2428fc","Старший финансовый консультант");
//            workProfileFSC2.getQueueIds().add(queueBigCredit2.getId());
//            workProfileFSC2.getQueueIds().add(queueCredit2.getId());
//
//            User psokolovUser2 = new User("1351b389-c444-493f-b6de-786eae18d756","psokolov");
...
//
//
//            creditService2.getPossibleOutcomes().put(creditAccepted2.getId(), creditAccepted2);
//
//
//            creditCard2.getPossibleOutcomes().put(creditCardGiven2.getId(),creditCardGiven2);
