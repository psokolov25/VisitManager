...
public class Visit {
  ...
  /**
   * Разница между текущим временем и временем возвращения. Если визит не возвращался, возвращает 0.
   *
  ...
  /**
   * Разница между текущим временем и временем перевода. Если визит не переводился, возвращает 0.
   *
