...
public enum VisitEvent {
    ...
    BACK_TO_USER_POOL, BACK_TO_QUEUE, BACK_TO_SERVICE_POINT_POOL, TRANSFER_TO_QUEUE, ADD_SERVICE, ADDED_DELIVERED_SERVICE, DELETED_DELIVERED_SERVICE,
    ...
    private static final Map<VisitEvent, List<VisitEvent>> nextEvents = Map.ofEntries(
            ...
            Map.entry(PLACED_IN_QUEUE, List.of(CALLED, RECALLED, VISIT_DELETED, ADDED_MARK, DELETED_MARK, TRANSFER_TO_SERVICE_POINT_POOL, TRANSFER_TO_USER_POOL,TRANSFER_TO_QUEUE)),
            ...
            Map.entry(START_SERVING, List.of(BACK_TO_USER_POOL, BACK_TO_QUEUE, BACK_TO_SERVICE_POINT_POOL, ADDED_MARK, DELETED_MARK, STOP_SERVING, END, TRANSFER_TO_SERVICE_POINT_POOL, TRANSFER_TO_USER_POOL, TRANSFER_TO_QUEUE, ADD_SERVICE, ADDED_DELIVERED_SERVICE, DELETED_DELIVERED_SERVICE, ADDED_SERVICE_RESULT, ADDED_MARK, DELETED_MARK)),
            Map.entry(STOP_SERVING, List.of(BACK_TO_USER_POOL, PLACED_IN_QUEUE, BACK_TO_SERVICE_POINT_POOL, ADDED_MARK, DELETED_MARK, END, VISIT_END_TRANSACTION, BACK_TO_QUEUE, ADDED_MARK, DELETED_MARK)),
            Map.entry(NO_SHOW, List.of(ADDED_MARK, DELETED_MARK)),
            Map.entry(END, List.of(ADDED_MARK, DELETED_MARK)),
            Map.entry(BACK_TO_SERVICE_POINT_POOL, List.of(PLACED_IN_QUEUE,CALLED, RECALLED, VISIT_DELETED, ADDED_MARK, DELETED_MARK, TRANSFER_TO_SERVICE_POINT_POOL)),
            Map.entry(BACK_TO_USER_POOL, List.of(PLACED_IN_QUEUE,CALLED, RECALLED, VISIT_DELETED, ADDED_MARK, DELETED_MARK, TRANSFER_TO_SERVICE_POINT_POOL)),
            Map.entry(BACK_TO_QUEUE, List.of(PLACED_IN_QUEUE,CALLED, RECALLED, VISIT_DELETED, ADDED_MARK, DELETED_MARK, TRANSFER_TO_SERVICE_POINT_POOL)),
            Map.entry(TRANSFER_TO_SERVICE_POINT_POOL, List.of(PLACED_IN_QUEUE,CALLED, RECALLED, VISIT_DELETED, ADDED_MARK, DELETED_MARK, TRANSFER_TO_SERVICE_POINT_POOL)),
            Map.entry(TRANSFER_TO_USER_POOL, List.of(PLACED_IN_QUEUE,CALLED, RECALLED, VISIT_DELETED, ADDED_MARK, DELETED_MARK, TRANSFER_TO_SERVICE_POINT_POOL)),
            Map.entry(TRANSFER_TO_QUEUE, List.of(PLACED_IN_QUEUE,CALLED, RECALLED, VISIT_DELETED, ADDED_MARK, DELETED_MARK, TRANSFER_TO_SERVICE_POINT_POOL)),
            ...
            Map.entry(DELETED_DELIVERED_SERVICE, List.of(ADDED_DELIVERED_SERVICE, ADDED_MARK, DELETED_MARK, STOP_SERVING, ADDED_SERVICE_RESULT, ADDED_DELIVERED_SERVICE_RESULT, DELETED_DELIVERED_SERVICE)),
            Map.entry(ADDED_DELIVERED_SERVICE, List.of(ADDED_DELIVERED_SERVICE, ADDED_MARK, DELETED_MARK, STOP_SERVING, ADDED_SERVICE_RESULT, ADDED_DELIVERED_SERVICE_RESULT, DELETED_DELIVERED_SERVICE)),
