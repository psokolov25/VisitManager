...
public enum VisitEvent {
    ...
    BACK_TO_USER_POOL,BACK_TO_QUEUE,BACK_TO_SERVICE_POINT_POOL, TRANSFER_TO_QUEUE, ADD_SERVICE, ADDED_DELIVERED_SERVICE,
    ...
    private static final Map<VisitEvent, List<VisitEvent>> nextEvents = Map.ofEntries(
            ...
            Map.entry(START_SERVING, List.of(BACK_TO_USER_POOL,BACK_TO_QUEUE,BACK_TO_SERVICE_POINT_POOL,ADDED_MARK,DELETED_MARK, STOP_SERVING, END, TRANSFER_TO_SERVICE_POINT_POOL, TRANSFER_TO_USER_POOL, TRANSFER_TO_QUEUE, ADD_SERVICE, ADDED_DELIVERED_SERVICE, ADDED_SERVICE_RESULT,ADDED_MARK,DELETED_MARK)),
