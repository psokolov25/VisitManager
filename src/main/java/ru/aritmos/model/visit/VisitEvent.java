...
public enum VisitEvent {
    ...
    private static final Map<VisitEvent, List<VisitEvent>> nextEvents = Map.ofEntries(
            ...
            Map.entry(START_SERVING, List.of(BACK_TO_QUEUE, STOP_SERVING, END, TRANSFER_TO_SERVICE_POINT_POOL, TRANSFER_TO_USER_POOL, TRANSFER_TO_QUEUE, ADD_SERVICE,ADDED_DELIVERED_SERVICE)),
            ...
            Map.entry(ADDED_DELIVERED_SERVICE, List.of(ADDED_DELIVERED_SERVICE,STOP_SERVING)),
    ...
    private static final Map<VisitEvent, VisitState> visitStateMap = Map.of(
            ...
            ADDED_DELIVERED_SERVICE,VisitState.SERVING,
