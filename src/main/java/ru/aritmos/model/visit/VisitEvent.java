...
public enum VisitEvent {
    ...
    private static final Map<VisitEvent, List<VisitEvent>> nextEvents = Map.ofEntries(
            ...
            Map.entry(PLACED_IN_QUEUE, List.of(CALLED, VISIT_DELETED,ADDED_MARK,DELETED_MARK)),
            Map.entry(CALLED, List.of(RECALLED, START_SERVING, NO_SHOW, BACK_TO_QUEUE,ADDED_MARK,DELETED_MARK)),
            Map.entry(RECALLED, List.of(RECALLED, START_SERVING, NO_SHOW, BACK_TO_QUEUE,ADDED_MARK,DELETED_MARK)),
            Map.entry(START_SERVING, List.of(BACK_TO_QUEUE,ADDED_MARK,DELETED_MARK, STOP_SERVING, END, TRANSFER_TO_SERVICE_POINT_POOL, TRANSFER_TO_USER_POOL, TRANSFER_TO_QUEUE, ADD_SERVICE, ADDED_DELIVERED_SERVICE, ADDED_SERVICE_RESULT,ADDED_MARK,DELETED_MARK)),
            Map.entry(STOP_SERVING, List.of(PLACED_IN_QUEUE,ADDED_MARK,DELETED_MARK, END, VISIT_END_TRANSACTION, BACK_TO_QUEUE,ADDED_MARK,DELETED_MARK)),
