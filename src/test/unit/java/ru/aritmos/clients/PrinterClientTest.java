...
class PrinterClientTest {
    ...
    @DisplayName("Интерфейс объявлен клиентом веб-сервиса через аннотацию фреймворка")
    @Test
    ...
    @DisplayName("Метод печати использует аннотации повторных попыток и очереди исполнения")
    @Test
