...
class VisitServiceMarkLookupByIdTest {
    ...
    @DisplayName("Метод addMark по идентификатору делегирует обработку найденной отметке")
    @Test
    ...
    @DisplayName("Метод deleteMark по идентификатору делегирует обработку найденной отметке")
    @Test
