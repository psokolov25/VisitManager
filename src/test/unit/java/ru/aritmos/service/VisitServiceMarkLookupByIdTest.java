...
class VisitServiceMarkLookupByIdTest {
    ...
    @DisplayName("Добавление отметки по идентификатору делегирует работу найденной сущности")
    @Test
    ...
    @DisplayName("Удаление отметки по идентификатору делегирует работу найденной сущности")
    @Test
