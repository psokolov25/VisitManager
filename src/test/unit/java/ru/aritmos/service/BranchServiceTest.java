...
class BranchServiceTest {
     ...
     */
    @DisplayName("Получение отделения возвращает существующий объект")
    @Test
     ...
     */
    @DisplayName("Получение отделения выбрасывает исключение при отсутствии")
    @Test
     ...
     */
    @DisplayName("Обновление групп услуг привязывает их к услугам")
    @Test
     ...
     */
    @DisplayName("Обновление групп услуг выбрасывает исключение при отсутствии услуги")
    @Test
     ...
     */
    @DisplayName("Проверка существования отделения определяет наличие")
    @Test
     ...
     */
    @DisplayName("Запрос отделений возвращает копию без деталей")
    @Test
     ...
     */
    @DisplayName("Запрос детализированных отделений возвращает оригинальные ссылки")
    @Test
     ...
     */
    @DisplayName("Сохранение отделения проставляет идентификаторы")
    @Test
     ...
     */
    @DisplayName("Изменение рабочего профиля точки обслуживания обновляет пользователя")
    @Test
     ...
     */
    @DisplayName("Изменение рабочего профиля выбрасывает исключение при отсутствии пользователя")
    @Test
     ...
     */
    @DisplayName("Закрытие точки обслуживания делегируется отделению")
    @Test
     ...
     */
    @DisplayName("Обновление существующего отделения отправляет событие")
    @Test
     ...
     */
    @DisplayName("Удаление отделения удаляет запись и отправляет событие")
    @Test
     ...
     */
    @DisplayName("Удаление выбрасывает исключение при отсутствии отделения")
    @Test
     ...
     */
    @DisplayName("Запрос услуг по профилю возвращает связанные услуги")
    @Test
     ...
     */
    @DisplayName("Запрос услуг по профилю выбрасывает исключение при отсутствии")
    @Test
     ...
     */
    @DisplayName("Запрос услуг по очереди возвращает связанные услуги")
    @Test
     ...
     */
    @DisplayName("Запрос услуг по очереди выбрасывает исключение при отсутствии")
    @Test
     ...
     */
    @DisplayName("Запрос выполненных услуг отделения возвращает список")
    @Test
     ...
     */
    @DisplayName("Обновление визита делегируется отделению")
    @Test
     ...
     */
    @DisplayName("Обновление визита с событием делегируется отделению")
    @Test
     ...
     */
    @DisplayName("Обновление визита с событием и флагом запуска делегируется отделению")
    @Test
     ...
     */
    @DisplayName("Обновление визита с событием и индексом делегируется отделению")
    @Test
     ...
     */
    @DisplayName("Открытие точки обслуживания назначает пользователя и профиль")
    @Test
     ...
     */
    @DisplayName("Открытие точки обслуживания публикует события об изменении пользователя")
    @Test
     ...
     */
    @DisplayName("Открытие точки обслуживания закрывает предыдущие назначения")
    @Test
     ...
     */
    @DisplayName("Открытие точки обслуживания завершает активный перерыв и уведомляет каналы")
    @Test
     ...
     */
    @DisplayName("Открытие точки обслуживания выбрасывает исключение при отсутствии доступа у пользователя")
    @Test
     ...
     */
    @DisplayName("Удаление отделения закрывает точки обслуживания")
    @Test
     ...
     * Бросает ошибку, если рабочий профиль не найден.
     */
    @DisplayName("Открытие точки обслуживания выбрасывает исключение при отсутствии рабочего профиля")
    @Test
     ...
     */
    @DisplayName("Открытие точки обслуживания выбрасывает исключение при отсутствии точки обслуживания")
    @Test
     ...
     */
    @DisplayName("Запрос пользователей возвращает сотрудников отделения")
    @Test
     ...
     */
    @DisplayName("Инкремент номера талона обновляет очередь")
    @Test
     ...
     */
    @DisplayName("Инкремент номера талона возвращает -1 при отсутствии очереди")
    @Test
     ...
     */
    @DisplayName("Обновление услуг делегируется отделению")
    @Test
     ...
     */
    @DisplayName("Удаление услуг делегируется отделению")
    @Test
     ...
     */
    @DisplayName("Обновление точек обслуживания делегируется отделению")
    @Test
     ...
     */
    @DisplayName("Удаление точек обслуживания делегируется отделению")
    @Test
     ...
     */
    @DisplayName("Обновление очередей делегируется отделению")
    @Test
     ...
     */
    @DisplayName("Удаление очередей делегируется отделению")
    @Test
     ...
     */
    @DisplayName("Обновление правил сегментации делегируется отделению")
    @Test
