...
class VisitServiceMarkModificationTest {
    ...
    @DisplayName("Метод addMark дополняет список отметок визита")
    @Test
    ...
    @DisplayName("Метод deleteMark удаляет отметку из визита")
    @Test
    ...
    @DisplayName("Метод addMark выбрасывает исключение при отсутствии текущей услуги")
    @Test
