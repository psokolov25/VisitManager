...
class VisitServiceDeliveredServicesTest {
    ...
    @DisplayName("Получение фактических услуг возвращает данные текущей услуги визита")
    @Test
    ...
    @DisplayName("Добавление фактической услуги прикрепляет её к текущей услуге")
    @Test
    ...
    @DisplayName("Удаление фактической услуги очищает её из текущей услуги")
    @Test
    ...
    @DisplayName("Установка исхода фактической услуги сохраняет результат обработки")
    @Test
    ...
    @DisplayName("Удаление исхода фактической услуги очищает сохранённый результат")
    @Test
