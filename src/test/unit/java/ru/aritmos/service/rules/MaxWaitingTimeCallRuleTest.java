...
class MaxWaitingTimeCallRuleTest {
    ...
    @DisplayName("Разбор даты из строки")
    @Test
     ...
     */
    @DisplayName("Вызов выбрасывает исключение при неверном рабочем профиле")
    @Test
    ...
    @DisplayName("Вызов с идентификаторами очередей выбирает визит")
    @Test
    ...
    @DisplayName("Вызов с идентификаторами очередей без пользователя приводит к исключению")
    @Test
    ...
    @DisplayName("Компаратор визитов учитывает флаги переноса")
    @Test
    ...
    @DisplayName("Вызов выбирает визит с максимальным временем ожидания")
    @Test
    ...
    @DisplayName("Вызов сбрасывает флаги переноса для выбранного визита")
    @Test
    ...
    @DisplayName("Вызов выбрасывает исключение при отсутствии пользователя")
    @Test
    ...
    @DisplayName("Компаратор визитов предпочитает более ранние даты переноса")
    @Test
    ...
    @DisplayName("Вызов игнорирует визиты без статуса WAITING")
    @Test
    ...
    @DisplayName("Вызов пропускает визиты до наступления задержки возвращения")
    @Test
    ...
    @DisplayName("Вызов с идентификаторами очередей возвращает пустой результат при ненаступившей задержке возвращения")
    @Test
    ...
    @DisplayName("Доступные точки обслуживания возвращают пустой список при отсутствии активных пользователей")
    @Test
