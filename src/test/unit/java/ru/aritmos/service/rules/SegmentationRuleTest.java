...
class SegmentationRuleTest {
    ...
    @DisplayName("Выбрасывает исключение при отсутствии правила сегментации")
    @Test
    ...
    @DisplayName("Возвращает привязанную очередь при отсутствии правил")
    @Test
    ...
    @DisplayName("Получение очереди по идентификатору выполняет скрипт на языке Груви")
    @Test
    ...
    @DisplayName("Получение очереди по идентификатору возвращает пусто при отсутствии значения")
    @Test
    ...
    @DisplayName("Получение очереди по идентификатору выбрасывает исключение без параметров")
    @Test
    ...
    @DisplayName("Получение очереди оборачивает бизнес-исключение в системное")
    @Test
    ...
    @DisplayName("Возвращает пусто при отсутствии связанной очереди")
    @Test
