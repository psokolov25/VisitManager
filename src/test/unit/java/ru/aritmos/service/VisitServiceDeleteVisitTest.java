...
class VisitServiceDeleteVisitTest {
    ...
    @DisplayName("Удаление визита выбрасывает исключение, если задержка возврата не истекла")
    @Test
    ...
    @DisplayName("Удаление визита выбрасывает исключение, если задержка перевода не истекла")
    @Test
