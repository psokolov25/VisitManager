...
class VisitServiceMaxCallRulesTest {
    ...
    @DisplayName("проверяется сценарий «visit call with maximal waiting time uses rule result»")
    @Test
    ...
    @DisplayName("проверяется сценарий «visit call with maximal waiting time enables autocall when rule returns empty»")
    @Test
    ...
    @DisplayName("проверяется сценарий «visit call with maximal waiting time fails when service point missing»")
    @Test
    ...
    @DisplayName("проверяется сценарий «visit call with max life time fails when service point missing»")
    @Test
    ...
    @DisplayName("проверяется сценарий «visit call with maximal waiting time fails when user not logged»")
    @Test
    ...
    @DisplayName("проверяется сценарий «visit call with max life time fails when user not logged»")
    @Test
    ...
    @DisplayName("проверяется сценарий «visit call with maximal waiting time returns empty when no auto call configured»")
    @Test
    ...
    @DisplayName("проверяется сценарий «visit call with max life time returns empty when no auto call configured»")
    @Test
    ...
    @DisplayName("проверяется сценарий «visit call with max life time uses rule result»")
    @Test
    ...
    @DisplayName("проверяется сценарий «visit call with max life time enables autocall when rule returns empty»")
    @Test
    ...
    @DisplayName("проверяется сценарий «visit call strategies do not trigger autocall for busy service point»")
    @Test
