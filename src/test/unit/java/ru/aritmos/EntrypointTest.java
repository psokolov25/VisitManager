...
class EntrypointTest {
    ...
    @DisplayName("Скрипт на языке Груви выбирает визит по заданным параметрам")
    @Test
    ...
    @DisplayName("Скрипт на языке Груви возвращает пустой результат при отсутствии совпадений")
    @Test
