...
class UserMapperTest {
    ...
    @DisplayName("Извлечение ролей из набора утверждений включает роли клиента и реалма")
    @Test
    ...
    @DisplayName("Извлечение ролей игнорирует некорректные структуры утверждений")
    @Test
