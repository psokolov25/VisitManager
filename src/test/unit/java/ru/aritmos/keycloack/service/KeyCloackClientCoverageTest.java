...
class KeyCloackClientCoverageTest {
    ...
    @DisplayName("Получение сессии пользователя по логину возвращает сессию с максимальным временем запуска")
    @Test
    ...
    @DisplayName("Получение сессии пользователя по логину возвращает пустой результат при некорректных данных")
    @Test
    ...
    @DisplayName("Проверка типа модуля пользователя по логину распознаёт составную роль")
    @Test
    ...
    @DisplayName("Получение пользователя по SID возвращает найденный экземпляр при существующей сессии")
    @Test
    ...
    @DisplayName("Принудительный выход пользователя отправляет события и дополняет параметры сессии")
    @Test
    ...
    @DisplayName("Получение отделений по названию региона возвращает дочерние отделения")
    @Test
    ...
    @DisplayName("Получение отделений по названию региона выбрасывает исключение при отсутствии региона")
    @Test
