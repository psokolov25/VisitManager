...
class EndSessionEndpointResolverReplacementTest {
  ...
  void resolveReturnsOktaEndpoint() {
    ...
    EndSessionEndpointResolverReplacement resolver =
        new EndSessionEndpointResolverReplacement(
            beanContext, securityConfiguration, tokenResolver);
    ...
    assertTrue(
        endpoint.get() instanceof OktaEndSessionEndpoint, "должен быть OktaEndSessionEndpoint");
  }
}
