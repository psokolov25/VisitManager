...
class KeyCloackClientTest {
    ...
    @DisplayName("Получение пути отделения по префиксу возвращает найденный путь")
    @Test
    ...
    @DisplayName("Получение пути отделения по префиксу возвращает null, если совпадение не найдено")
    @Test
    ...
    @DisplayName("Получение отделений по идентификатору региона рекурсивно собирает дочерние отделения")
    @Test
    ...
    @DisplayName("Повторное получение клиента Keycloak возвращает существующий экземпляр")
    @Test
    ...
    @DisplayName("Получение сведений о пользователе возвращает найденного пользователя")
    @Test
    ...
    @DisplayName("Получение сведений о пользователе возвращает пустой результат при отсутствии пользователя")
    @Test
