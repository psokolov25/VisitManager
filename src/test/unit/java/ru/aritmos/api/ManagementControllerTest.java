...
class ManagementControllerTest {
    ...
    @DisplayName("Метод getBranch возвращает найденный филиал")
    @Test
    ...
    @DisplayName("Метод getBranch выбрасывает 404 при отсутствии филиала")
    @Test
    ...
    @DisplayName("Получение отделений без указания пользователя возвращает все филиалы")
    @Test
    ...
    @DisplayName("Получение отделений для неизвестного пользователя возвращает полный список")
    @Test
    ...
    @DisplayName("Получение отделений для администратора возвращает полный список")
    @Test
    ...
    @DisplayName("Получение отделений фильтрует филиалы по доступу пользователя")
    @Test
    ...
    @DisplayName("Получение сокращённых данных по отделениям возвращает преобразованный список")
    @Test
