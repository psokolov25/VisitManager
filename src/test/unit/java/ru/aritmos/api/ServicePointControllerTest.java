...
class ServicePointControllerTest {
    ...
    @DisplayName("Запрос свободных точек делегируется сервису визитов")
    @Test
    ...
    @DisplayName("Получение сотрудников отделения выполняет сервис отделений")
    @Test
    ...
    @DisplayName("Смена рабочего профиля делегируется сервису отделений")
    @Test
    ...
    @DisplayName("Открытие точки обслуживания выполняет сервис отделений")
    @Test
    ...
    @DisplayName("Закрытие точки обслуживания выполняет сервис отделений")
    @Test
    ...
    @DisplayName("Запрос списка принтеров выполняет сервис визитов")
    @Test
    ...
    @DisplayName("Запрос очередей выполняет сервис визитов")
    @Test
    ...
    @DisplayName("Запрос детализированных очередей делегируется сервису визитов")
    @Test
    ...
    @DisplayName("Запрос точек обслуживания преобразует данные в компактную модель")
    @Test
    ...
    @DisplayName("Запрос детализированных точек возвращает исходную коллекцию")
    @Test
    ...
    @DisplayName("Поиск точки по имени пользователя возвращает связанную запись")
    @Test
    ...
    @DisplayName("Получение работающих сотрудников делегируется сервису визитов")
    @Test
    ...
    @DisplayName("Глобальный поиск точки по имени пользователя обращается к сервису отделений")
    @Test
    ...
    @DisplayName("Запрос рабочих профилей делегируется сервису визитов")
    @Test
    ...
    @DisplayName("Завершение смены оператора закрывает точку через сервис отделений")
    @Test
    ...
    @DisplayName("Запрос визитов с ограничением количества выполняет сервис визитов")
    @Test
    ...
    @DisplayName("Запрос визитов без ограничения выполняет сервис визитов")
    @Test
    ...
    @DisplayName("Запрос карты всех визитов возвращает данные сервиса визитов")
    @Test
    ...
    @DisplayName("Поиск визита по идентификатору выполняет сервис визитов")
    @Test
    ...
    @DisplayName("Фильтрация визитов по статусам делегируется сервису визитов")
    @Test
    ...
    @DisplayName("Поиск визита в очереди возвращает 404 при отсутствии данных")
    @Test
    ...
    @DisplayName("Вызов визита делегируется сервису визитов")
    @Test
    ...
    @DisplayName("Вызов визита для подтверждения возвращает ответ сервиса визитов")
    @Test
    ...
    @DisplayName("Вызов визита для подтверждения по идентификатору загружает визит из сервиса")
    @Test
    ...
    @DisplayName("Вызов визита для подтверждения с ожиданием использует сервис визитов")
    @Test
    ...
    @DisplayName("Вызов визита из нескольких очередей делегируется сервису визитов")
    @Test
    ...
    @DisplayName("Вызов визита для подтверждения из очередей делегируется сервису визитов")
    @Test
    ...
    @DisplayName("Обработка неявки визита делегируется сервису визитов")
    @Test
    ...
    @DisplayName("Обработка неявки по идентификатору предварительно загружает визит")
    @Test
    ...
    @DisplayName("Повторный вызов визита для подтверждения выполняет сервис визитов")
    @Test
    ...
    @DisplayName("Повторный вызов визита по идентификатору загружает данные из сервиса")
    @Test
    ...
    @DisplayName("Подтверждение визита выполняет сервис визитов")
    @Test
    ...
    @DisplayName("Подтверждение визита по идентификатору загружает данные из сервиса")
    @Test
    ...
    @DisplayName("Отмена автообзвона точки обслуживания делегируется сервису визитов")
    @Test
    ...
    @DisplayName("Включение автообзвона точки и отделения делегируется сервису визитов")
    @Test
    ...
    @DisplayName("Запрос настроенных исходов возвращает данные сервиса отделений")
    @Test
    ...
    @DisplayName("Вызов визита по максимальному времени ожидания делегируется сервису визитов")
    @Test
    ...
    @DisplayName("Вызов визита по максимальному времени ожидания из очередей делегируется сервису визитов")
    @Test
    ...
    @DisplayName("Вызов визита для подтверждения по максимальному времени ожидания делегируется сервису визитов")
    @Test
    ...
    @DisplayName("Вызов визита для подтверждения по максимальному времени ожидания из очередей делегируется сервису визитов")
    @Test
    ...
    @DisplayName("Запрос выдаваемых услуг фильтрует записи по идентификатору услуги")
    @Test
    ...
    @DisplayName("Запрос выдаваемых услуг текущей точки делегируется сервису визитов")
    @Test
    ...
    @DisplayName("Получение услуг по рабочему профилю делегируется сервису отделений")
    @Test
    ...
    @DisplayName("Получение услуг по очереди делегируется сервису отделений")
    @Test
    ...
    @DisplayName("Запрос выдаваемых услуг отделения обращается к сервису отделений")
    @Test
    ...
    @DisplayName("Добавление выдаваемой услуги делегируется сервису визитов")
    @Test
    ...
    @DisplayName("Пакетное добавление услуг последовательно вызывает сервис визитов")
    @Test
    ...
    @DisplayName("Удаление визита через идентификатор выполняет сервис визитов")
    @Test
