...
class DataBusClientTest {
  ...
  @DisplayName("Интерфейс клиента аннотирован URL сервиса")
  @Test
  ...
  @DisplayName("Метод send содержит HTTP- и асинхронные аннотации")
  @Test
  ...
  @DisplayName("Метод send содержит все заголовки и параметры")
  @Test
