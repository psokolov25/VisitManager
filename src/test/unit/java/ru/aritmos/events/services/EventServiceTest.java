...
class EventServiceTest {
    ...
    @DisplayName("Форматирование даты возвращает строку в формате стандартного заголовка даты")
    @Test
    ...
    @DisplayName("Отправка события об изменении формирует сообщение об изменённой сущности")
    @Test
    ...
    @DisplayName("Отправка события заполняет отправителя и вызывает клиента")
    @Test
    ...
    @DisplayName("Отправка события об изменении нескольким адресатам формирует сообщение для каждого сервиса")
    @Test
