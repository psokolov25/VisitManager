...
class EventServiceTest {
    ...
    @DisplayName("Форматирование даты возвращает строку в формате RFC 1123")
    @Test
    ...
    @DisplayName("Отправка события изменения формирует событие ENTITY_CHANGED")
    @Test
    ...
    @DisplayName("Отправка события проставляет отправителя и вызывает клиента")
    @Test
    ...
    @DisplayName("Отправка на несколько направлений вызывает клиента для каждого сервиса")
    @Test
    ...
    @DisplayName("Отправка события изменения на несколько направлений формирует событие для каждого сервиса")
    @Test
