 ...
 *
 * <p>Класс инкапсулирует два именованных логгера: для шагов ({@code TEST_STEPS})
 * и проверок ({@code TEST_CHECKS}). Сообщения используются расширением
 * {@link TestLoggingExtension}, а также вспомогательными утверждениями.
 */
final class TestLog {
    ...
    /**
     * Логирует ситуацию, когда не удалось сформировать детальное сообщение для
     * проверки.
     *
