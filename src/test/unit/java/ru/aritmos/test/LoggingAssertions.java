...
public final class LoggingAssertions {
    ...
    public static void assertEquals(Object expected, Object actual, String message) {
        ...
        runCheck("assertEquals", () -> base, null, () -> Assertions.assertEquals(expected, actual, message));
    }
    ...
    public static void assertTrue(boolean condition) {
        runCheck("assertTrue", () -> "condition=" + condition, null, () -> Assertions.assertTrue(condition));
    }
    ...
    public static void assertFalse(boolean condition) {
        runCheck("assertFalse", () -> "condition=" + condition, null, () -> Assertions.assertFalse(condition));
    }
    ...
    public static void assertFalse(BooleanSupplier condition) {
        runCheck("assertFalse", () -> "conditionSupplier", null, () -> Assertions.assertFalse(condition));
    }
    ...
    public static void assertSame(Object expected, Object actual, String message) {
        String base = joinDetails(formatExpectedActual(expected, actual), formatMessage(message));
        runCheck("assertSame", () -> base, null, () -> Assertions.assertSame(expected, actual, message));
    }
    ...
    public static void assertNotEquals(Object unexpected, Object actual) {
        String base = formatExpectedActual(unexpected, actual);
        runCheck("assertNotEquals", () -> base, null, () -> Assertions.assertNotEquals(unexpected, actual));
    }

    public static void assertNotEquals(Object unexpected, Object actual, String message) {
        String base = joinDetails(formatExpectedActual(unexpected, actual), formatMessage(message));
        runCheck("assertNotEquals", () -> base, null, () -> Assertions.assertNotEquals(unexpected, actual, message));
    }

    public static void assertNotNull(Object actual) {
        runCheck("assertNotNull", () -> "value=" + formatValue(actual), null, () -> Assertions.assertNotNull(actual));
    }
    ...
    public static void assertNotNull(Object actual, Supplier<String> messageSupplier) {
        runCheck(
            ...
            () -> joinDetails("value=" + formatValue(actual), formatMessage(safeMessage(messageSupplier))),
            () -> Assertions.assertNotNull(actual, messageSupplier));
    }

    public static void assertNull(Object actual) {
        runCheck("assertNull", () -> "value=" + formatValue(actual), null, () -> Assertions.assertNull(actual));
    }

    public static void assertArrayEquals(Object[] expected, Object[] actual) {
        String base = formatExpectedActual(expected, actual);
        runCheck("assertArrayEquals", () -> base, null, () -> Assertions.assertArrayEquals(expected, actual));
    }
    ...
    public static void assertDoesNotThrow(Executable executable, Supplier<String> messageSupplier) {
        runCheck(
            ...
            () -> joinDetails("executable=" + describeExecutable(executable), formatMessage(safeMessage(messageSupplier))),
    ...
    public static <T> T assertDoesNotThrow(ThrowingSupplier<T> supplier, Supplier<String> messageSupplier) {
        return runCheckWithResult(
            ...
            () -> joinDetails("supplier=" + describeExecutable(supplier), formatMessage(safeMessage(messageSupplier))),
    ...
    private static void runCheck(
        ...
        try {
            ...
            String failureDetails = failureDetailsSupplier != null ? safeGet(failureDetailsSupplier) : startDetails;
    ...
    private static <R> R runCheckWithResult(
        ...
        try {
            ...
            String successDetails = successDetailsSupplier != null ? safeApply(successDetailsSupplier, result) : null;
