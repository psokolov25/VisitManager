...
class GroovyScriptTest {
    ...
    @Test
    @DisplayName("Построитель по умолчанию создаёт пустые изменяемые карты входных и выходных параметров")
    ...
    @Test
    @DisplayName("Модель скрипта помечена аннотацией сериализации и всегда включает карты параметров")
