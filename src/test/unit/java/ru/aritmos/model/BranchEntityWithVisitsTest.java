...
class BranchEntityWithVisitsTest {
    ...
    @DisplayName("Конструктор с именем генерирует идентификатор и сохраняет название")
    @Test
    ...
    @DisplayName("Конструктор с идентификатором использует переданные значения")
    @Test
