...
class BranchConfigurationOperationsTest {
    ...
    @DisplayName("Обновление визита с пользовательским действием размещает сущности и отправляет события")
    @Test
    ...
    @DisplayName("Обновление визита с пользовательским действием выбрасывает конфликт при занятой точке")
    @Test
    ...
    @DisplayName("Добавление и обновление точек обслуживания восстанавливает состояние и публикует события")
    @Test
    ...
    @DisplayName("Добавление и обновление очередей восстанавливает визиты и уведомляет потребителей")
    @Test
