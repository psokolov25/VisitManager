...
class ApplicationConfigurerTest {
    ...
    @DisplayName("Включает профиль инфраструктуры по умолчанию при наличии удалённых сервисов")
    @Test
    ...
    @DisplayName("Добавляет профиль инфраструктуры к явно указанным окружениям")
    @Test
