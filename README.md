...
[![Tests](https://img.shields.io/badge/tests-432%20passing-brightgreen)](#-тестирование)
[![Docs](https://img.shields.io/badge/Docs-Use%20Cases-blue)](docs/use-cases.md)
[![Coverage](https://img.shields.io/badge/Coverage-62.2%25-orange)](#-тестирование)
...
## 🧪 Тестирование
Команда ниже выполняет 432 модульных теста и формирует отчёт JaCoCo с линейным покрытием 62,2%.
```bash
