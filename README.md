...
[![Tests](https://img.shields.io/badge/tests-416%20passing-brightgreen)](#-тестирование)
[![Docs](https://img.shields.io/badge/Docs-Use%20Cases-blue)](docs/use-cases.md)
[![Coverage](https://img.shields.io/badge/Coverage-56.3%25-orange)](#-тестирование)
...
## 🧪 Тестирование
Команда ниже выполняет 416 модульных тестов и формирует отчёт JaCoCo с линейным покрытием 56,3%.
```bash
...
- ru.aritmos.service.VisitServiceTransferToServicePointPoolTest — проверяет перевод визита из точки обслуживания в пул, корректное
  формирование событий и реакцию на отсутствие точки обслуживания или визита.
