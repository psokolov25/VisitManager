...
Команда ниже выполняет 454 модульных тестов и формирует отчёт JaCoCo с линейным покрытием 74,0%.
...
- ru.aritmos.service.VisitServiceUncoveredOperationsTest — закрывает ранее непокрытые сценарии `VisitService`: перенос визита из точки обслуживания в очередь, возврат визита в пул сотрудника, перевод в пул пользователя и в пул точки обслуживания с учётом данных внешних сервисов.
