...
| Сотрудники отделения | `GET /servicepoint/branches/{branchId}/users` | `200 OK` + список сотрудников; `404 Not Found` или `500 Internal Server Error` при ошибках | `ServicePointController#getUsersOfBranch` 【F:src/main/java/ру/aritмос/api/ServicePointController.java†L268-L291】 |
| Очереди отделения | `GET /servicepoint/branches/{branchId}/queues/full` | `200 OK` + подробности очередей; `404 Not Found` если отделение не найдено; `500 Internal Server Error` при сбое | `ServicePointController#getFullQueues` 【F:src/main/java/ру/aritмос/api/ServicePointController.java†L150-L165】 |
| Каталог услуг | `GET /entrypoint/branches/{branchId}/services/all` | `200 OK` + массив услуг; `404 Not Found` при неизвестном отделении; `500 Internal Server Error` при сбое | `EntrypointController#getAllServices` 【F:src/main/java/ру/aritмос/api/EntrypointController.java†L442-L457】 |
| Список принтеров | `GET /servicepoint/branches/{branchId}/printers` | `200 OK` + перечень устройств; `404 Not Found` или `500 Internal Server Error` при ошибке | `ServicePointController#getPrinters` 【F:src/main/java/ру/aritмос/api/ServicePointController.java†L102-L117】 |
| Создание визита с печатью | `POST /entrypoint/branches/{branchId}/printer/{printerId}/visitWithParameters?printTicket=true` с телом `VisitParameters` | `200 OK` + JSON визита; `400 Bad Request`; `404 Not Found`; `500 Internal Server Error` | `EntrypointController#createVisitFromReception` 【F:src/main/java/ру/aritмос/api/EntrypointController.java†L302-L372】 |
| Создание визита без печати | `POST /entrypoint/branches/{branchId}/printer/{printerId}/visitWithParameters?printTicket=false` | `200 OK` + JSON визита; `400/404/500` в тех же случаях, что и при печати | `EntrypointController#createVisitFromReception` 【F:src/main/java/ру/aritмос/api/EntrypointController.java†L302-L372】 |
| Аннулирование визита | `DELETE /servicepoint/branches/{branchId}/visits/{visitId}` | `204 No Content`; `404 Not Found`; `409 Conflict`; `500 Internal Server Error` | `ServicePointController#deleteVisit` 【F:src/main/java/ру/aritмос/api/ServicePointController.java†L2334-L2363】 |
| Перенос визита в конец очереди | `PUT /servicepoint/branches/{branchId}/queue/{queueId}/visits/{visitId}/externalService/transfer?isAppend=true` с `serviceInfo` | `200 OK` + обновленный визит; `404 Not Found`; `500 Internal Server Error` | `ServicePointController#visitTransferFromQueue` 【F:src/main/java/ру/aritмос/api/ServicePointController.java†L2724-L2764】 |
| Перенос визита в начало очереди | `PUT /servicepoint/branches/{branchId}/queue/{queueId}/visits/{visitId}/externalService/transfer?isAppend=false` | `200 OK` + обновленный визит; `404 Not Found`; `500 Internal Server Error` | `ServicePointController#visitTransferFromQueue` 【F:src/main/java/ру/aritмос/api/ServicePointController.java†L2724-L2764】 |
| Перевод в пул точки обслуживания (конец) | `PUT /servicepoint/branches/{branchId}/servicePoint/{servicePointId}/pool/visits/{visitId}/externalService/transfer?isAppend=true` | `200 OK` + визит в пуле; `404 Not Found`; `500 Internal Server Error` | `ServicePointController#visitTransferFromQueueToServicePointPool` 【F:src/main/java/ру/aritмос/api/ServicePointController.java†L2994-L3034】 |
| Перевод в пул точки обслуживания (начало) | `PUT /servicepoint/branches/{branchId}/servicePoint/{servicePointId}/pool/visits/{visitId}/externalService/transfer?isAppend=false` | `200 OK` + визит в пуле; `404 Not Found`; `500 Internal Server Error` | `ServicePointController#visitTransferFromQueueToServicePointPool` 【F:src/main/java/ру/aritмос/api/ServicePointController.java†L2994-L3034】 |
| Перевод в пул сотрудника (конец) | `PUT /servicepoint/branches/{branchId}/users/{userId}/pool/visits/{visitId}/externalService/transfer?isAppend=true` | `200 OK` + визит в пуле сотрудника; `404 Not Found`; `500 Internal Server Error` | `ServicePointController#visitTransferFromQueueToUserPool` 【F:src/main/java/ру/aritмос/api/ServicePointController.java†L3295-L3321】 |
| Перевод в пул сотрудника (начало) | `PUT /servicepoint/branches/{branchId}/users/{userId}/pool/visits/{visitId}/externalService/transfer?isAppend=false` | `200 OK` + визит в пуле сотрудника; `404 Not Found`; `500 Internal Server Error` | `ServicePointController#visitTransferFromQueueToUserPool` 【F:src/main/java/ру/aritмос/api/ServicePointController.java†L3295-L3321】 |
| Открытие точки | `POST /servicepoint/branches/{branchId}/servicePoints/{servicePointId}/workProfiles/{workProfileId}/users/{userName}/open` | `200 OK` + JSON пользователя; `404 Not Found`; `409 Conflict` при занятой точке | `ServicePointController#openServicePoint` 【F:src/main/java/ру/aritмос/api/ServicePointController.java†L492-L511】 |
| Вызов визита | `POST /servicepoint/branches/{branchId}/servicePoints/{servicePointId}/confirmed/visits/call` | `200 OK` + JSON визита; `204 No Content`; `207 Multi-Status`; `403/404` при ошибках доступа | `ServicePointController#visitCallForConfirmMaxWaitingTime` 【F:src/main/java/ру/aritмос/api/ServicePointController.java†L973-L982】 |
| Подтверждение визита | `POST /servicepoint/branches/{branchId}/visits/servicePoints/{servicePointId}/confirmed/confirm/{visitId}` | `200 OK` + JSON визита; `404 Not Found`; `409 Conflict` при повторном подтверждении | `ServicePointController#visitConfirm` 【F:src/main/java/ру/aritмос/api/ServicePointController.java†L1386-L1434】 |
| Пустая очередь | `POST /servicepoint/branches/{branchId}/servicePoints/{servicePointId}/confirmed/visits/call` при отсутствии визитов | `204 No Content` | `ServicePointController#visitCallForConfirmMaxWaitingTime` 【F:src/main/java/ру/aritмос/api/ServicePointController.java†L973-L982】 |
| Перевод визита из точки обслуживания | `PUT /servicepoint/branches/{branchId}/visits/servicePoints/{servicePointId}/queue/{queueId}/visit/transferFromServicePoint?isAppend=true` | `200 OK` + JSON визита; `404 Not Found`; `500 Internal Server Error` | `ServicePointController#visitTransfer` 【F:src/main/java/ру/aritмос/api/ServicePointController.java†L2366-L2414】 |
| Ошибка перевода визита | тот же `transferFromServicePoint` с неверными данными | `400 Bad Request`; `404 Not Found`; `409 Conflict` | `ServicePointController#visitTransfer` 【F:src/main/java/ру/aritмос/api/ServicePointController.java†L2366-L2414】 |
